const htmlLoader = (function () {
    ...
    const files = [
        ...
        { id: 'new-lesson-choose-date-dlg', file: './html/lessons/new-lesson-choose-date-dlg.html' },
        { id: 'new-lesson-choose-student-dlg', file: './html/lessons/new-lesson-choose-student-dlg.html' },
        { id: 'lesson-options-dlg', file: './html/lessons/lesson-options-dlg.html' },
        ...
        { id: 'more-task-req-dlg', file: './html/tasks/more-task-req-dlg.html' },
